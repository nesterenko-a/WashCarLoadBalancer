...
const WASHES: CarWash[] = [
  { id: 'wash_a', name: 'Мойка A', coordinates: [1100, 1900], posts: 4, serviceTimeMin: { sedan: 8, truck: 25, heavy_truck: 38, bus: 40 }, supportedTypes: ['sedan', 'truck'], isActive: true, schedule: { openHour: 0, closeHour: 24 } },
  { id: 'wash_b', name: 'Мойка B', coordinates: [4750, 1900], posts: 3, serviceTimeMin: { sedan: 10, truck: 30, heavy_truck: 45, bus: 40 }, supportedTypes: ['sedan', 'truck', 'heavy_truck', 'bus'], isActive: true, schedule: { openHour: 0, closeHour: 24 } },
  { id: 'wash_e', name: 'Мойка E', coordinates: [4550, 4400], posts: 5, serviceTimeMin: { sedan: 7, truck: 22, heavy_truck: 35, bus: 36 }, supportedTypes: ['sedan', 'truck', 'heavy_truck', 'bus'], isActive: true, schedule: { openHour: 0, closeHour: 24 } },
];
